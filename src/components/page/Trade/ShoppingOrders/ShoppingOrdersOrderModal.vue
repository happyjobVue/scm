...
const searchDetail = () => {
    axios.post('/api/trade/orderingInstructionBody.do', {orderId: id}).then(res => {
                ...
                <table>
                    ...
                    <tbody>
                        <template v-if="orderingInstruction">
                            ...
                            <tr>
                                <th>발주개수</th>
                                <td><input type="number" v-model="selectedCount"
                                        :min="orderingInstruction ? orderingInstruction.workOrderCount : 0"/></td>
                            </tr>
                    </template>
                    </tbody>
                </table>
